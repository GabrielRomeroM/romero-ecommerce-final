        ...
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <p className="footer-description">
              Tu tienda de confianza para productos de supermercado con la mejor
              calidad y precios.
            </p>
            <div className="footer-contact">
              <p>
                <i className="fas fa-envelope"></i> info@supermarket.com
              </p>
              <p>
                <i className="fas fa-phone"></i> +1 (234) 567-890
              </p>
              <p>
                <i className="fas fa-map-marker-alt"></i> Av. Principal 123,
                Ciudad
              </p>
            </div>
          </div>
